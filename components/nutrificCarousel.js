    ...
    <Carousel activeIndex={index} onSelect={handleSelect}>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            Sign up or Sign in using your email and password; stored in
            Firebase.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            Set up your profile and enter your physical information. The
            application will calculate your BMI, BMR, calorie expenditure and
            your daily caloric need based on your goal weight.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            Using the search feature, quickly look up foods and their nutrition
            facts that you ate during the day.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Journal</h3>
          <p>
            The journal will list all the foods you have entered into a specific
            date; allowing you to see how many calories of what foods you ate.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            Add your own foods and approximate calories if you could not find it
            in the search.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        <img className="d-block w-40 center" src={nutrificHome} alt="Sign In" />
        <Carousel.Caption>
          <h3>Home</h3>
          <p>
            Track how many more calories you need to fulfill your daily goal.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
    </Carousel>
