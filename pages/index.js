...
class Index extends React.Component {
  ...
  moveFalling() {
    ...
    if (this.fallMount) {
      ...
      document.getElementById("fallingThree").style.marginTop =
        currScroll * 0.9;
    }
  }
  ...
  render() {
    ...
    return (
      ...
      <Layout scrollToRef={this.scrollToRef}>
        ...
        <div className="home">
          {new Date().toLocaleTimeString("en-GB") < "12"
            ? "good morning"
            : new Date().toLocaleTimeString("en-GB") < "18"
            ? "good afternoon"
            : "good evening"}
          <button
        ...
        <div ref={this.secondRef}>
          <Applications
            knowItAllGif={this.state.knowItAllGif}
            navBarGif={this.state.navBarGif}
            nutrific={this.state.nutrific}
            showGif={this.showGif}
            color={socialColor}
          />
        </div>
        <Footer />
